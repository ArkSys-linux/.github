...
After installing ArkSys you can install extra packages with your package manager (pacman, apt, dnf, zypper). Execute [menu.sh](./installation/post/menu.sh) `sh ./installation/post/menu.sh` for Arch linux or create your own script like:
